    ...
    <div className="max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className="flex flex-col h-full justify-center">
        ...
        <p className="pb-6">
          ...
          earum, quae dolores pariatur tempore a debitis accusamus omnis,
          voluptatum harum molestias aperiam, blanditiis voluptatibus mollitia
          doloribus error nisi neque?
        </p>
        <div>
          <button className="border-black mr-4 hover:shadow-xl">
            Learn More
          </button>
          <button className="border-blue-950 mr-4 bg-blue-900 text-white hover:border-red-700 hover:scale-105">
            Book Your Trip
          </button>
        </div>
      </div>
